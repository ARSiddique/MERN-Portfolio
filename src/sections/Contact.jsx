...
import { FaPaperPlane, FaWhatsapp, FaPhoneAlt, FaLinkedinIn, FaEnvelope } from "react-icons/fa";
...
export default function Contact() {
  ...
  const errors = useMemo(() => {
    ...
    else if (formData.message.trim().length < 10) e.message = "Message should be at least 10 characters.";
    return e;
  }, [formData]);
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setStatus((s) => ({ ...s, success: "", error: "" })), 3200);
